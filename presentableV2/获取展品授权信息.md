...
```
url1: https://api.freelog.com/v2/auths/presentable/{presentableId}/{result|info|resourceInfo|fileStream}
url1: https://api.freelog.com/v2/auths/presentable/nodes/{nodeId}/{resourceIdOrName}/{result|info|resourceInfo|fileStream}
```
