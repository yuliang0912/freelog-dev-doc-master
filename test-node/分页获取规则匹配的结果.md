...
```js
{
	...
	"data": {
		...
		"dataList": [{
			...
			"differenceInfo": {
				"onlineStatusInfo": {
					"ruleId": "1b72abbf85bb43b69271ae22f76c5889",
					"isOnline": 1
				},
				"userDefinedTagInfo": {
					"tags": ["tag1", "tag2", "tag3"],
			...
			"rules": [{
				"id": "1b72abbf85bb43b69271ae22f76c5889",
				"operation": "online"
			}],
			"resolveReleases": [{
				"contracts": [{
			...
			"createDate": "2019-10-23T06:16:32.512Z",
			"updateDate": "2019-10-23T06:16:32.512Z"
		}, {
			"previewImages": ["https://image.freelog.com/preview/b042cd88-cc9a-43fb-b8fb-1cae320b7977.jpg"],
			...
			"rules": [{
				"id": "84a6beb6340148a98e38fb39edadddfd",
				"operation": "replace"
			}],
			"resolveReleases": [{
				"contracts": [{
