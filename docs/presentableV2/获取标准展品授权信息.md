...
测试节点环境:
url1: https://api.freelog.com/v2/auths/exhibits/testResources/{exhibitId}/{result|info|fileStream}
url2: https://api.freelog.com/v2/auths/exhibits/testResoruces/{nodeId}/{workIdOrName}/{result|info|fileStream}
```
