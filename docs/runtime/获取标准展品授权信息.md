...
url2: https://api.freelog.com/v2/auths/exhibits/{nodeId}/works/{workIdOrName}/{result|info|fileStream}
测试节点环境:
url1: https://api.freelog.com/v2/auths/exhibits/{nodeId}/test/{exhibitId}/{result|info|fileStream}
url2: https://api.freelog.com/v2/auths/exhibits/{nodeId}/test/works/{workIdOrName}/{result|info|fileStream}
```
