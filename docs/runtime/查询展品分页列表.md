...
测试环境
https://api.freelog.com/v2/exhibits/test/{nodeId}
```
...
| workResourceTypes | 可选 | string |作品资源类型,多个用逗号分隔 |
| omitWorkResourceType | 可选 | string | 忽略的作品资源类型,与resourceType参数互斥 |
...
```json
{
	...
	"data": {
		...
		"dataList": [{
			...
			"userId": 50022,
			"workInfo": {
				"workId": "605355cb347afb003a54ceea",
				"workName": "Freelog/markdown-theme",
				"resourceType": "theme",
				"workType": 1,
				"workOwnerId": 0,
