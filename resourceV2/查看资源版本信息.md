...
```
URL1: https://api.freelog.com/v2/resources/{resourceId}/versions/{version}?projection={projection}
URL2: https://api.freelog.com/v2/resources/versionss/detail?versionId={versionId}&projection={projection}
```
