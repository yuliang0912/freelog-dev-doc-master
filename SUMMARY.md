...
* [授权方案](auth-scheme/README.md)
    * [创建授权方案](auth-scheme/创建授权方案.md)
    * [更新授权方案](auth-scheme/更新授权方案.md)
    * [查看授权方案详情](auth-scheme/查看授权方案详情.md)
    * [查看授权方案列表](auth-scheme/查看授权方案列表.md)
    * [查看授权方案关联的合同](auth-scheme/查看授权方案关联的合同.md)
    * [处理依赖与签约](auth-scheme/处理依赖与签约.md)
    * [获取授权方案的策略段身份认证结果](auth-scheme/获取授权方案的策略段身份认证结果.md)
